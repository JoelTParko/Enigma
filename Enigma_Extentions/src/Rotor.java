...
public abstract class Rotor
{
    ...
    //In order to use the mapping variable defined in rotor, a setter method was needed to set the values in the mapping variable
    protected void setMapping(int[] mapping)
    {
        this.mapping = mapping;
    }

    //In order to use the mapping variable defined in rotor, a getter method was needed to access the mapping variable
