...
public class EnigmaFile
{
    ...
    //This constructor allows an enigma machine that has already been set up to be used by the enigma file
    public EnigmaFile(String fileLocation, EnigmaMachine enigmaMachine)
    {
        this.fileLocation = fileLocation;
